      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative flex flex-col mt-2">
          ...
          {contacts.map((c) => {
            ...
            return (
              ...
              >
                ...
                {/* Middle Row: Details (No Phone Text) */}
                ...
                {/* Bottom Row: Action Buttons Centered - Expandable */}
          ...
          {contacts.length === 0 && !loading && (
            <div className="p-16 text-center text-gray-500 flex flex-col items-center justify-center gap-2 bg-slate-50/20">
